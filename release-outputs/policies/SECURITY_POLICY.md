...
**アプリ名**: 効棋 (Kouki)  
**パッケージ**: com.petitworksapps.kouki  
**最終更新**: 2026-05-23
...
| `RECORD_AUDIO` / マイク | 音声入力機能（棋譜の音声読み上げ操作）。利用時のみアクセス |

**要求しない権限**: カメラ、位置情報、連絡先、ストレージ

---

## 脆弱性報告

セキュリティ上の問題を発見された場合は、公開前に **support@petitworksapps.example** へご連絡ください。
