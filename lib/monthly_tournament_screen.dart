      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPrizeRow(
                '🥇', '1位', '称号「月例覇者」+ 限定アバターフレーム + Rating +150', const Color(0xFFFFD700)),
            const SizedBox(height: 8),
            _buildPrizeRow('🥈', '2位', '限定称号バッジ + 特別駒テーマ解放 + Rating +80', const Color(0xFFC0C0C0)),
            const SizedBox(height: 8),
            _buildPrizeRow('🥉', '3位', '特別駒テーマ解放 + Rating +40', const Color(0xFFCD7F32)),
            const SizedBox(height: 8),
            _buildPrizeRow('🏅', '4〜8位', 'コイン ×200 + Rating +15', const Color(0xFF80CBC4)),
            const SizedBox(height: 8),
            _buildPrizeRow('🎖️', '参加賞', 'コイン ×100 + 参加バッジ', const Color(0xFF90CAF9)),
          ],
        ),
      ),
    );
